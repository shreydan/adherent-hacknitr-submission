...
<div classNameName="container">
  ...
  <div class="form" style={{marginLeft:"30px"}}>
    <input id="search-input" type="search" class="form-control" placeholder="Search your locality.." style={{width:"18rem" , backgroundColor:"#0000003d"}}/>
  </div>
  <button type="submit" class="btn btn-primary" style={{backgroundColor:"purple" , width:"5rem"}} >
  Search
  </button>
</div>
